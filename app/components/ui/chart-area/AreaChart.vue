<template>
  <div :class="cn('w-full flex flex-col items-end', $attrs.class ?? '')">
    ...
    <VisXYContainer :style="{ height: isMounted ? props.height : 'auto' }" :margin="{ left: 20, right: 20 }" :data>
      ...
      <ChartCrosshair v-if="showTooltip" :colors :items="legendItems" :index :custom-tooltip />
